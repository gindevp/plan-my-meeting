...
const dictionaries: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "sidebar.calendar": "Lịch họp",
    "sidebar.plans": "Quản lý kế hoạch",
    "sidebar.invitations": "Lời mời",
    "sidebar.notifications": "Thông báo",
    "sidebar.schedule": "Lên lịch họp",
  ...
  en: {
    ...
    "sidebar.plans": "Plan Management",
    "sidebar.invitations": "My Invitations",
    "sidebar.notifications": "Notifications",
    "sidebar.schedule": "Schedule Meeting",
